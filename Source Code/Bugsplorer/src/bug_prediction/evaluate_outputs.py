...
if __name__ == "__main__":
    ...
    input_dir = "/root/autodl-tmp/outputs/cross_project"       # npz文件所在目录
    output_csv = "/root/autodl-tmp/results/cross_project.csv"  # 输出结果文件
    '''
    input_dir = "/root/autodl-tmp/outputs"       # npz文件所在目录
    output_csv = "/root/autodl-tmp/results/cross_version.csv"  # 输出结果文件
    '''
