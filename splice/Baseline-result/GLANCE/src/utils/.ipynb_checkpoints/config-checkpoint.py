...
CODE_PATH = '/root/autodl-tmp/SPLICE/Baseline-result/GLANCE/'
...
# Cross-project evaluation releases (test releases for each training project)
ALL_EVAL_RELS_PROJECTS = {'activemq': ['activemq-5.1.0', 'activemq-5.2.0', 'activemq-5.3.0', 'activemq-5.8.0'], 
